...
ROOT_DIR = "/home/guest/data/g1/g1_datacollection_yuanmeng/g1_feedback" #/g1_exp_50hz_20250715_145741
ZARR_PATH = os.path.join(ROOT_DIR, "g1_walk_5hz.zarr")  # file path for the zarr results
MOTOR_IDX = list(range(29))
Q_COLS = [f'low_m{i}_q' for i in MOTOR_IDX]
ACTION_COLS = ["low_wireless_remote", "sport_vel1", "sport_vel2", "sport_yaw_speed"]
