...
ROOT_DIR = "/home/fuxiao/data/quadruped_walk"
...
def main():
    ...
    zarr_root.create_dataset('agent_pose', data=all_agent_pose, chunks=(100, all_agent_pose.shape[1]), dtype='float32', overwrite=True)
    zarr_root.create_dataset('action', data=all_action, chunks=(100, all_action.shape[1]), dtype='float32', overwrite=True)
    zarr_root.create_dataset('episode_ends', data=episode_ends, chunks=(100,), dtype='int64', overwrite=True)
